...
1. - [~] Task: Update `convex/schema.ts` to add `bio`, `inventory`, `currentGoal`, `lastReflectedTick`, `actionStartedAt`, `interactionPartnerId`, `lastThought`, `speech`, and `lastSpeechAt`.
