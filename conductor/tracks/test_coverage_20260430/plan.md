...
## Phase 1: Utility Modules (Simple First)
...
### Task 2.1: Write tests for `src/components/ui/NeedsBar.tsx`
- [ ] Write failing unit test: Render NeedsBar with label, value, and color
- [ ] Write failing unit test: Verify value clamps between 0-100
- [ ] Write failing unit test: Verify percentage text displays correctly
- [ ] Write failing unit test: Verify framer-motion animation width matches percentage
- [ ] Implement to make tests pass
- [ ] Verify coverage >80% for `src/components/ui/NeedsBar.tsx`
- [ ] Commit changes (`test(ui): Add unit tests for NeedsBar component`)
...
### Task 3.1: Write unit tests for `convex/functions/ai_helpers.ts` (pure functions)
...
- [ ] Implement to make tests pass
- [ ] Verify coverage coverage for pure functions
- [ ] Commit changes (`test(convex): Add unit tests for ai_helpers pure functions`)

### Task 3.2: Write integration tests for `convex/functions/ai_helpers.ts` (Convex actions)
...
- [ ] Task: Conductor - User Manual Verification 'Phase 3: Backend Functions' (Protocol in workflow.md)
